    ...
    def render(self, draw, x, y):
        ...
        draw.arc(
            (
                battery_x,
                battery_y,
                battery_x + 2 * self.corner_radius,
                battery_y + 2 * self.corner_radius,
            ),
            180,
            270,
        ...
        draw.arc(
            (
                battery_x + self.battery_width - 2 * self.corner_radius,
                battery_y,
                battery_x + self.battery_width,
                battery_y + 2 * self.corner_radius,
            ),
            270,
            0,
        ...
        draw.line(
            [
                (battery_x + self.corner_radius, battery_y),
        ...
        draw.line(
            [
                (battery_x + self.corner_radius, battery_y + self.battery_height),
                (
                    battery_x + self.battery_width - self.corner_radius,
                    battery_y + self.battery_height,
                ),
            ],
            fill=self.outline_color,
        ...
        draw.line(
            [
                (battery_x, battery_y + self.corner_radius),
        ...
        draw.line(
            [
                (battery_x + self.battery_width, battery_y + self.corner_radius),
                (
                    battery_x + self.battery_width,
                    battery_y + self.battery_height - self.corner_radius,
                ),
            ],
            fill=self.outline_color,
            width=self.line_width,
        ...
        if fill_color != (0, 0, 0):
            draw.rectangle(
                [
                    battery_x + self.line_width // 2,
                    battery_y + self.line_width // 2,
        ...
        draw.rectangle(
            [head_x, head_y, head_x + self.head_width, head_y + self.head_height],
            fill=self.outline_color,
        )
        ...
        text_y = (
            ...
            + (
                self.battery_height
                - (
                    self.battery_font.getmetrics()[0]
                    + self.battery_font.getmetrics()[1]
                )
            )
            // 2
        )
        ...
        draw.text(
            (text_x, text_y), battery_text, font=self.battery_font, fill=text_fill_color
        )
